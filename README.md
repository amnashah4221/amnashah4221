...
- **Cuisine Craft** – Recipe & meal discovery app using **React**.
...
## 🌱 Current Focus
- **Final Year Project (FYP):** AI-powered voice assisted medical chatbot system 
- **AI & LLMs:** Exploring AI-driven solutions productivity apps  
- **Full-stack Development:** MERN stack for scalable web apps  
- **UI/UX Design:** Using **Figma** for wireframes & interactive prototypes  
